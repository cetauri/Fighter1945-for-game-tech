...
-(void)move {
	...
	id actionRemove = [CCCallFuncN actionWithTarget:battleField selector:@selector(spriteMoveFinished:)];
	[self runAction:[CCSequence actions:actionMove, actionRemove, nil]];	
}
